...
map_fig = px.scatter_mapbox(office_df, lat="lat", lon="lon", size_max=10, hover_name = 'office',zoom=1, color = 'black', size = [2,2,2,2,2,2,2,2], center = {'lat':51.5147672,'lon':-0.072115})
