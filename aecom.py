...
map_fig = px.scatter_mapbox(office_df, lat="lat", lon="lon", size_max=20, hover_name = 'office',zoom=5, size = [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,10,2,2,2,2,2,2,2,2,2,2,2],center = {'lat':55.3781,'lon':3.4360})
